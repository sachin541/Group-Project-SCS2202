            ...
            <?php if (!empty($orderDetails)):
                ...
                <div class="details-flex-container">
                    <div class="details-group">
                        <div class="detail"><strong>Order ID:</strong> <?= htmlspecialchars($firstItem['order_id']) ?>
                        </div>
                    ...
                    <div class="details-group">
                        ...
                        <div class="detail"><strong>Province:</strong> <?= htmlspecialchars($firstItem['province']) ?>
                        </div>
                    </div>
                    <div class="details-group">
