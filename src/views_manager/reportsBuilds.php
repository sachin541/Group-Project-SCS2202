...
<!-- scripts -->
<script src="/resources/js/js_manager/reportsBuilds.js"></script>
<script src="/resources/js/js_manager/reportsBuildsChart.js"></script>
<!-- chart.js -->
...
<!-- this script is copied to reportsBuilds,js -->
<!-- <script>
