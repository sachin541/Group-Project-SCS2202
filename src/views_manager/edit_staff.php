...
<!-- stylesheets -->
<link rel="stylesheet" href="/resources/css/css_manager/add_emp.css" />
...
<form action="../helpers/employee_handler.php" method="post" enctype="multipart/form-data">
    ...
    <div>
        <select name="emp_role" required>
            ...
            <option value="deliverer" <?= $staffDetails['emp_role'] == "deliverer" ? 'selected' : '' ?>>Deliverer
            </option>
            <option value="technician" <?= $staffDetails['emp_role'] == "technician" ? 'selected' : '' ?>>Technician
            </option>
        </select>
    </div>
    ...
    <div>
        <input type="text" name="staff_name" placeholder="Name" required
            value="<?= htmlspecialchars($staffDetails['staff_name']) ?>">
    </div>
    <div>
        <input type="text" name="staff_address" placeholder="Address" required
            value="<?= htmlspecialchars($staffDetails['staff_address']) ?>">
    </div>
    <div>
        <input type="text" name="mobile_no" placeholder="Mobile Number" required
            value="<?= htmlspecialchars($staffDetails['mobile_no']) ?>">
    </div>
    <div>
        <input type="date" name="date_of_birth" required
            value="<?= htmlspecialchars($staffDetails['date_of_birth']) ?>">
    </div>
    <div>
        <input type="number" name="sal" placeholder="Salary" required
            value="<?= htmlspecialchars($staffDetails['sal']) ?>">
    </div>
    <div>
