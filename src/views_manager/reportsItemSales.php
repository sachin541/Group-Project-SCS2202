...
<!-- scripts -->
<script src="reportsItemSales.js"></script>
<script src="reportsItemSalesChart1.js"></script>
<script src="reportsItemSalesChart2.js"></script>
<!-- chart.js -->
...
<!-- this script copied to reportsItemSales.js -->
<!-- <script>
...
<!-- this script is copied to reportsItemSalesChart1.js -->
<!-- <script>
    document.addEventListener('DOMContentLoaded', function () {
...
<!-- this script is copied to reportsItemSalesChart2.js -->
<!-- <script>
    document.addEventListener('DOMContentLoaded', function () {
