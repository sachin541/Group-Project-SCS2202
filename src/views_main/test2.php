    ...
    <div>
        ...
        <ul>
            <li style="--accent-color:#080a0d">
                <div class="date">
                    <?php echo "✔️ Request created!" ?>
                </div>
                <div class="title">
                    <div style="margin-bottom: 20px;">REF No :
                        <?php echo $ref_number ?>
                    </div>
                    <div style="margin-bottom: 20px;">Date :
                        <?php echo $start_date ?>
                    </div>
                    <div class="descr">A repair order for the item '
                        <?php echo $item_name; ?>' has been successfully created. We will promptly assign a technician
                        to handle your repair needs.
                    </div>
            </li>
            <li style="--accent-color:#080a0d">
                <div class="date">
                    <?php echo "✔️ Technician assigned!" ?>
                </div>
                <div style="margin-bottom: 20px;"></div>
                <div style="margin-bottom: 20px;">Technician Name :
                    <?php echo $tech_name ?>
                </div>
                <div style="margin-bottom: 20px;">Technician Mobile :
                    <?php echo $tech_mobile ?>
                </div>
                <div style="margin-bottom: 20px;">Date :
                    <?php echo $tech_date ?>
                </div>
            ...
            <li style="--accent-color:#080a0d">
                <div class="date">
                    <?php echo "✔️ Repair in progress!" ?>
                </div>
                <div style="margin-bottom: 20px;"></div>
                <div style="margin-bottom: 20px;">Date :
                    <?php echo $repair_start_date ?>
                </div>
                <div class="descr">Repair is in progress.</div>
            </li>
            <li style="--accent-color:#080a0d">
                <div class="date">
                    <?php echo "✔️ Repair completed!" ?>
                </div>
                <div style="margin-bottom: 20px;"></div>
                <div style="margin-bottom: 20px;">Date :
                    <?php echo $repair_completed_date ?>
                </div>
                <div class="descr">Repair has been completed item is read for collection.</div>
            </li>
            <li style="--accent-color:#080a0d">
                <div class="date">
                    <?php echo "✔️ Payment made!" ?>
                </div>
                <div style="margin-bottom: 20px;"></div>
                <div style="margin-bottom: 20px;">Date :
                    <?php echo $payment_done_date ?>
                </div>
