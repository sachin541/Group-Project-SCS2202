...
<!-- stylesheets -->
<link rel="stylesheet" href="/resources/css/css_customer/checkout.css">
    ...
    <div class="box-style">
        ...
        <form onsubmit="return handleSubmit()" action="../helpers/checkout_handler.php" method="post"
            ...
            <div>
                ...
                <input type="text" id="delivery_address" name="delivery_address" placeholder="Delivery Address"
                    required>
            </div>
...
<div id="paymentPendingModal" class="modal">
    <div class="modal-content">
        ...
        <p>You have more than one pending payment. Please clear your pending payments before proceeding with Pay on
            Delivery.</p>
...
<!-- <script src="/resources/js/js_customer/checkout.js"></script> -->

<!-- template bottom -->
<?php require_once '../components/templates/main-bottom.php'; ?>


<!-- this script copied to the checkout.js -->
