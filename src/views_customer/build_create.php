...
<!-- stylesheets -->
<link rel="stylesheet" href="/resources/css/css_customer/create_build.css">
                        ...
                        <div class="component-item">
                            <?php if ($productDetails['image1']) { ?>
                                <img class="component-image"
                                    src="data:image/jpeg;base64,<?= base64_encode($productDetails['image1']) ?>"
    ...
    <div class="additional-info info-section">
        ...
        <form action="../helpers/build_create.php" method="post" class="build-form">
            ...
            <div class="total-price">
                <p class="total-label">Total Price: <span
                        class="price"><?= htmlspecialchars(formatPrice($totalPrice)) ?></span></p>
            </div>
            <!-- hidden fields -->
