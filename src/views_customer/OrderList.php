...
$orders = $inStore->getAllOrders($filterBy, $sortBy, $paymentType, $paymentStatus, $deliveryStatus, $userId);
...
<!-- stylesheets -->
<link rel="stylesheet" href="/resources/css/css_customer/MyOrders.css">
    ...
    <div class="filter-sort-container">
        ...
        <form action="" method="GET">
            ...
            <select name="paymentType" class="filter-dropdown">
                ...
                <option value="pay_on_delivery" <?php echo $paymentType == 'Pay On Delivery' ? 'selected' : ''; ?>>Pay On
                    Delivery</option>
            ...
            <select name="paymentStatus" class="filter-dropdown">
                ...
                <option value="Payment Completed" <?php echo $paymentStatus == 'Completed' ? 'selected' : ''; ?>>Completed
                </option>
            </select>
            ...
            <tbody>
                <?php foreach ($orders as $order): ?>
                    <tr class="table-data-row">
                        ...
                        <td>
                            <a href="./OrderDetails.php?order_id=<?php echo $order['order_id']; ?>" class="details-button">View
                                Details</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
...
<!-- scripts -->
<script src="/resources/js/js_customer/OrderList.js"></script>

<!-- template bottom -->
<?php require_once '../components/templates/main-bottom.php'; ?>


<!-- this script is copied to OrderList.js -->
<!-- <script>
