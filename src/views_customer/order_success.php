            ...
            <div class="customer-details">
                <table class="details-table">
                    <tr>
                        <td>Date:</td>
                        <td>
                            <?= htmlspecialchars($firstItem['created_at']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Name:</td>
                        <td>
                            <?= htmlspecialchars($firstItem['first_name']) . ' ' . htmlspecialchars($firstItem['last_name']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Email:</td>
                        <td>
                            <?= htmlspecialchars($firstItem['email']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Phone:</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= htmlspecialchars($firstItem['delivery_city_address']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>City:</td>
                        <td>
                            <?= htmlspecialchars($firstItem['city']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Province:</td>
                        <td>
                            <?= htmlspecialchars($firstItem['province']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Postal Code:</td>
                        <td>
                            <?= htmlspecialchars($firstItem['postalcode']) ?>
                        </td>
                    </tr>
                </table>
            </div>
