            ...
            <div class="noitems">
                ...
                <?php else: ?>
                        ...
                        <tbody>
                            <?php foreach ($cartItems as $item): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo htmlspecialchars(formatPrice($item['price'])); ?>
                                    </td>
                                    <td>
                                        <?php echo htmlspecialchars($productobj->getProductStockById($item['id'])); ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo htmlspecialchars(formatPrice($subtotal)); ?>
                                    </td>
                                </tr>
                    ...
                    <div class="cart-total">
                        <h2>Total:
                            <?php echo htmlspecialchars(formatPrice($totalAmount)); ?>
                        </h2>
