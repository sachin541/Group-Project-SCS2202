...
<!-- stylesheets -->
<link rel="stylesheet" href="/resources/css/css_staff/OrdersDeliverySub.css" />
<link rel="stylesheet" href="/resources/css/css_staff/toggleswitch.css" />


<div class="orders-container">

    <div class="orders-header">
        <a href="./OrdersDeliverySub.php" class="<?php echo $pageType == "Delivery" ? 'active' : ''; ?>">Online
            Orders</a>
