...
<!-- stylesheets -->
<link rel="stylesheet" href="/resources/css/css_staff/product_edit.css">
...
<form action="../helpers/edit_product.php" method="post" enctype="multipart/form-data" class="product-form">
    ...
    <div class="form-group product-name-group">
        ...
        <input type="text" id="product_name" name="product_name" class="form-input product-name-input"
            value="<?php echo htmlspecialchars($product['product_name']); ?>" required>
    </div>

    <div class="form-group category-group">
        <label for="category" class="form-label category-label">Category:</label>
        <input type="text" id="category" name="category" class="form-input category-input"
    ...
    <div class="form-group description-group">
        ...
        <textarea id="product_description" name="product_description" class="form-textarea description-textarea"
    ...
    <div class="form-group price-group">
        ...
        <input type="text" id="price" name="price" class="form-input price-input"
            value="<?php echo htmlspecialchars($product['price']); ?>" required>
    </div>

    <div class="form-group discount-group">
        <label for="discount" class="form-label discount-label">Discount:</label>
        <input type="text" id="discount" name="discount" class="form-input discount-input"
    ...
    <div class="form-group brand-group">
        ...
        <input type="text" id="brand" name="brand" class="form-input brand-input"
